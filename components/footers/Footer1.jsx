                ...
                <div className="col-lg-4">
                  <div className="footer-infor">
                    ...
                    <div className="footer-address" >
                      <p>Plot No. 136, Ecotech-1 Extension, <br/> Greater Noida, G.B. Nagar, <br/> Uttar Pradesh-201308</p>
                      <Link
                        href={`/contact`}
                        style={{ color : "var(--bs-pink) !important" }}
                    ...
                    >
                      {socialLinks.map((link, index) => (
                        <li key={index} >
                          <a href={link.href} className={link.className} style={{backgroundColor : "#ffffff" , color: "#000000 !important" , }}>
                  ...
                  <div className="footer-col-block">
                    ...
                    <div className="tf-collapse-content">
                      <div className="footer-newsletter">
                        <p className="text-caption-1" style={{ color : "#fff !important"}}>
                        ...
                        <div className="tf-cart-checkbox">
                          ...
                          >
                            ...
                            <Link className="fw-6 link" href={`/term-of-use`} style={{ color : "var(--bs-pink) !important"}}>
                              Terms of Service
                            </Link>{" "}
                            and{" "}
                            <a className="fw-6 link" href="#" style={{ color : "var(--bs-pink) !important"}}>
                              Privacy Policy
                            </a>
                            .
                          </label>
                  ...
                  <div className="footer-bottom-wrap">
                    <div className="left">
                      <p className="text-caption-1">
                        ©{new Date().getFullYear()} MOZACK. All Rights Reserved.
                      </p>
                    </div>
